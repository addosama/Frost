...
public class FR {
    ...
    public FR(String fontName, int fontType, int size, boolean allChar) {
        this(fontName, fontType, size, 0, allChar);
    }

    public FR(String fontName, int fontType, int size, int kerning, boolean allChar) {
        this(fontName, fontType, size, kerning, allChar, 0);
    }

    public FR(String fontName, int fontType, int size, int kerning, boolean allChar, int yAddon) {
    ...
    private Font getFont(String fontName, int fontType, int size) {
        ...
        try {
            InputStream ex = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("frost/fonts/" + fontName)).getInputStream();
    ...
    public int drawHeightCenteredString(String text, float x, float y, int color) {
        return drawString(text, x, y-FONT_HEIGHT/2, color);
    }
