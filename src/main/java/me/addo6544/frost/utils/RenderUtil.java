...
public class RenderUtil {
    ...
    public static void drawWHRect(float left, float top, float width, float height, int color){
    ...
    public static void drawRect(double x, double y, double right, double bottom, int color) {
        RenderUtil.resetColor();
        GLUtil.setup2DRendering(() -> GLUtil.render(GL11.GL_QUADS, () -> {
            RenderUtil.color(color);
            GL11.glVertex2d(x, y);
            GL11.glVertex2d(x, bottom);
